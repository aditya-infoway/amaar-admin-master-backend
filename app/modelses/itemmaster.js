...
module.exports = sequelize => {
  const attributes = {
    ...
    unit: { type: DataTypes.STRING(50), allowNull: false, field: "unit" },
     thickness: { type: DataTypes.DECIMAL(12, 3), allowNull: false, defaultValue: 0, field: "thickness" },
   length: { type: DataTypes.DECIMAL(12, 3), allowNull: false, defaultValue: 0, field: "length" },
    width: { type: DataTypes.DECIMAL(12, 3), allowNull: false, defaultValue: 0, field: "width" },
